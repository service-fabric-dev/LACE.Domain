...
namespace LACE.Domain.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var configLoader = new BindingConfigurationLoader(Configuration);
            var modules = new IModule[]
            {
                new DataModule(configLoader)
            };
            ...
            services.AddScoped<MachineConfigurations>();
        }
